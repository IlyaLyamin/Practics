def polynom_znach(x, n, cfs): # принимает на вход корень - x, степень многочлена - n, коэфиценты - cfs и считает значение многочлена
    s = 0
...
def znach_proiz(x, n, cfs):  # принимает на вход то же самое что и первая функция, считает значение многочлена производной многочлена
    s_proiz = 0
    for i in range(n): 
